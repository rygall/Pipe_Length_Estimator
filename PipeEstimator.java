...
public class PipeEstimator {
    ...
    public static void main(String[] args) {
        ...
        while (!(unitsInput.equalsIgnoreCase("meters") || unitsInput.equalsIgnoreCase("feet") || unitsInput.equalsIgnoreCase("inches"))) {
            System.out.println("Enter the units of measurement that you are using to measure the length of the section of pipe (meters, feet or inches): ");
        ...
        //tallying up all the lengths of the different pipe sections
        ...
        System.out.printf("\nThe estimated number of 90 degree elbows: %d", elbows90);
        System.out.printf("\nThe estimated number of 45 degree elbows: %d\n\n\n", elbows45);
